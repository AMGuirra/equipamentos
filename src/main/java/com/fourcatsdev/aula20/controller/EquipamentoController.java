...
public class EquipamentoController {
	...
	@RequestParam(value = "dataDevolucao") String dataDevolucao, @RequestParam(value = "finalidade") String finalidade,
			RedirectAttributes attributes) throws ParseException, EquipamentoNotFoundException {
		
		if (ids == null || ids.length == 0) {
			attributes.addFlashAttribute("mensagemErro", "Selecione pelo menos um equipamento.");
			return "redirect:/equipamento/listar";
		}
		...
		attributes.addFlashAttribute("pedidoRealizado", true);
		return "redirect:/pedido/solicitados";
