...
public class PedidoController {
	...
	public String listarPedido(Model model, @CurrentSecurityContext(expression = "authentication.name") String login){
		return listarPedidosSolicitados(model, login);
	}

	@RequestMapping("/solicitados")
	public String listarPedidosSolicitados(Model model, @CurrentSecurityContext(expression = "authentication.name") String login){
	    ...
	    return "/auth/user/user-pedidos-solicitados";
	}
